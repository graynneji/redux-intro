...
const accountSlice = createSlice({
  ...
  reducers: {
    ...
    //do if you want your action creator to recieve more than one argument
    //you can pass it as an object so its only one argument but if you do want this two argument then use prepare
    requestLoan: {
